    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-[#fafafa]">{t("login.title")}</h1>
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-[#a1a1aa] mb-1">{t("login.email")}</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm text-[#a1a1aa] mb-1">{t("login.password")}</label>
              <input
                type="password"
                value={password}
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#18181b] px-2 text-[#52525b]">{t("login.or")}</span>
            </div>
          </div>
